...
class AEv2(nn.Module):
    ...
    def encode(self, X):
        ...
        if self.batch_norm:
            hidden1 = activation_func(self.bn1(self.fc1(X)))
        else:
            hidden1 = activation_func(self.fc1(X))
...
class AEv2wrapper:
    ...
    def __init__(self,
        ...
        self.dim_output = dim_output
        self.batch_norm = batch_norm
        self.model = AEv2(dim_input, dim_output, hidden_activation, batch_norm)
